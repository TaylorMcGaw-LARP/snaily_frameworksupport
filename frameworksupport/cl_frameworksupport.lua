			...
			CreateThread(function()
				...
				if pluginConfig.usingQBCore then
					...
					AddEventHandler('QBCore:Client:OnJobUpdate', function(job)
						...
						TriggerServerEvent('snailyCAD::frameworksupport:refreshJobCache')
						TriggerEvent('snailyCAD::frameworksupport:JobUpdate', job)
					end)
				else
				...
				RegisterNetEvent('snailyCAD::frameworksupport:returnIdentity')
				AddEventHandler('snailyCAD::frameworksupport:returnIdentity', function(data)
				...
				function GetIdentity(callback)
					...
					TriggerServerEvent('snailyCAD::frameworksupport:getIdentity')
